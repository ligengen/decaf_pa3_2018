...
public abstract class Tree {
    ...
    public static final int COLON = GUARD + 1;
    public static final int ARRAYCONSTANT = COLON + 1;
    public static final int ARRAYREPEAT = ARRAYCONSTANT + 1;
    public static final int ARRAYCONCAT = ARRAYREPEAT + 1;
    public static final int SUBARRAY = ARRAYCONCAT + 1;
    public static final int DYNAMICACCESS = SUBARRAY + 1;
    public static final int PYTHONARR = DYNAMICACCESS + 1;
    public static final int FOREACH = PYTHONARR + 1;
    ...
    public static class ClassDef extends Tree {
        ...
        public ClassDef(String name, String parent, List<Tree> fields, Location loc, boolean sealed) {
            super(CLASSDEF, loc);
            this.name = name;
            this.parent = parent;
            this.fields = fields;
    	...
    	public void printTo(IndentPrintWriter pw) {
            ...
            if(this.sealed) {
                classname = "sealed class ";
            }
            pw.println(classname + name + " "
    ...
    public abstract static class LValue extends Expr {
    	...
    	public enum Kind {
    		LOCAL_VAR, PARAM_VAR, MEMBER_VAR, ARRAY_ELEMENT, UNKNOWN_VAR
    	}
    	public Kind lvKind;
    ...
    public static class Ident extends LValue {
        ...
        public Location recv_loc;
        public Location var_loc;

        public Ident(Expr owner, String name, Location loc, Location loc1) {
            super(IDENT, loc);
    		this.owner = owner;
    		this.name = name;
    		this.recv_loc = loc1;
        ...
        public Ident(String name, Location loc, boolean var, Location loc2) {
            super(IDENT, loc);
            this.name = name;
            this.var = var;
            this.var_loc = loc2;
    ...
    public static class Scopy extends Expr {
        ...
        public Expr instance;
        public Location idName_loc;
        public Location expr_loc;
        public Variable symbol;

        public Scopy(String idName, Expr instance, Location loc, Location loc1, Location loc2) {
            super(SCOPY, loc);
            this.idName = idName;
            this.instance = instance;
            this.idName_loc = loc1;
            this.expr_loc = loc2;
        }
    ...
    public static class Guard extends Tree {
        ...
        public Expr expr;
        public Tree stmt;
        public boolean stmt_exist = false;
        public boolean multi = false;
        public Tree ifsubstmt;
        public List<Tree> stmts;
        public Tree serialstmt;
        public boolean serial = false;

        public Guard(Location loc, boolean empty) {
            super(GUARD, loc);
            this.empty = empty;
        }

        public Guard(Location loc, Expr expr, Tree stmt, boolean exist) {
            super(GUARD, loc);
            this.expr = expr;
            this.stmt = stmt;
            this.stmt_exist = exist;
        }

        public Guard(Location loc, Tree stmt, boolean mul) {
            super(GUARD, loc);
            this.multi = mul;
            this.ifsubstmt = stmt;
        }

        public Guard(Location loc, List<Tree> ilist, Tree ifsubstmt, boolean b) {
            super(GUARD, loc);
            this.stmts = ilist;
            this.serialstmt = ifsubstmt;
            this.serial = b;
        }
    ...
    public static class ArrayConstant extends Expr {
        ...
        public ArrayConstant(Location loc) {
            super(ARRAYCONSTANT, loc);
            empty = true;
        }

        public ArrayConstant(Location loc, List<Expr> elist) {
            super(ARRAYCONSTANT, loc);
            mul = true;
            this.elist = elist;
        }
    ...
    public static class ArrayRepeat extends Expr {
        ...
        public Expr expr;
        public Expr intconst;
        public Location expr_loc;
        public Location intconst_loc;
        public ArrayRepeat(Location loc, Expr expr, Expr intconst, Location loc1, Location loc2){
            super(ARRAYREPEAT, loc);
            this.expr = expr;
            this.intconst = intconst;
            this.expr_loc = loc1;
            this.intconst_loc = loc2;
        }

        @Override
        public void accept(Visitor v) {
            v.visitArrayRepeat(this);
        }
    ...
    public static class ArrayConcat extends Expr {
        ...
        public ArrayConcat(Location loc, Expr left, Expr right) {
    ...
    public static class SubArray extends Expr {
        ...
        public SubArray(Location loc, Expr _1, Expr _3, Expr _5) {
            super(SUBARRAY, loc);
            this._1 = _1;
            this._3 = _3;
            this._5 = _5;
    ...
    public static class DynamicAccess extends Expr {

        public Expr _1;
        public Expr _2;
        public Expr _3;
        public Location _1_loc;
        public Location _2_loc;
        public Location _3_loc;

        public DynamicAccess(Location loc, Expr _1, Expr _2, Expr _3, Location _1_loc, Location _2_loc, Location _3_loc) {
            super(DYNAMICACCESS, loc);
            this._1 = _1;
            this._2 = _2;
            this._3 = _3;
            this._1_loc = _1_loc;
    ...
    public static class PythonArr extends Expr {
        ...
        public PythonArr(Location loc, Expr _1, String ident, Expr _2) {
            super(PYTHONARR, loc);
            this._1 = _1;
            this.ident = ident;
            this._2 = _2;
        ...
        public PythonArr(Location loc, Expr _1, String ident, Expr _2, Expr _3) {
            super(PYTHONARR, loc);
            this._1 = _1;
            this.ident = ident;
            this._2 = _2;
    ...
    public static class Foreach extends Tree {
        ...
        public Tree _3;
        public TypeLiteral type;
        public boolean _while = false;
        public Block foreachblock;
        public List<Tree> list = new ArrayList<Tree>();
        public Location x_loc;
        public Location e_loc;
        public Location b_loc;
        public Location s_loc;
        public Variable symbol;

        public Foreach(Location loc, TypeLiteral type, String name, Expr _1, Tree stmt, Location x_loc, Location e_loc, Location s_loc) {
            super(FOREACH, loc);
            this.var_ = name;
            this._1 = _1;
            this._3 = stmt;
            ...
            if(stmt instanceof Block) {
                for(Tree t:((Tree.Block)stmt).block) {
                    list.add(t);
                }
            }
            else
                list.add(stmt);
            foreachblock = new Block(list, loc);
            if(type != null)
                this.type = type;
            else
                this.type = new TypeIdent(Tree.UNKNOWN, loc);
        }

        public Foreach(Location loc, TypeLiteral type, String name, Expr _1, Expr _2, Tree stmt, Location x_loc, Location e_loc, Location b_loc, Location s_loc) {
            super(FOREACH, loc);
            this.var_ = name;
            this._1 = _1;
            this._2 = _2;
    ...
    public static abstract class Visitor {
        ...
        public void visitDynamicAccess(DynamicAccess that) {
            visitTree(that);
        }

        public void visitPythonArr(PythonArr that) {
            visitTree(that);
        }
