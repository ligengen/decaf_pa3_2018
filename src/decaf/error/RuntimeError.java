...
public final class RuntimeError {
	...
	public static final String DIVIDE_ZERO = "Decaf runtime error: Division by zero error.\n";

	public static final String REPEAT_LESS_THAN_ZERO = "Decaf runtime error: The length of the created array should not be less than 0.\n";
}
